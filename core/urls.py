...
from .views import PostingListView, MyPostingListView, PostingCreateView, PostingDetailView, ApplicationsListView, ApplicationsSearchView, ApplicationsDetailView, ApplicationsCreateView, PostingSearchView, PostingDeleteView, apply

urlpatterns = [
    path("posting/list", PostingListView.as_view(), name="posting-list"),
    path("posting/mylist", MyPostingListView.as_view(), name="posting-mylist"),
